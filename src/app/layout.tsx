...
export const metadata: Metadata = {
  title: "BrewLoft | Premium Specialty Coffee & Artisanal Pastries",
  description: "Experience exceptional artisan coffee and fresh pastries at BrewLoft. Premium espresso, cappuccinos, and locally-sourced ingredients in a welcoming atmosphere.",
  keywords: "specialty coffee, cappuccino, espresso, coffee shop, artisanal pastries, barista",
  openGraph: {
    title: "BrewLoft | Premium Specialty Coffee",
    description: "Artisan coffee crafted daily with passion and precision",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765798893651-bktzx2js.jpg",
        alt: "BrewLoft specialty coffee"
      }
    ],
    siteName: "BrewLoft"
  }
